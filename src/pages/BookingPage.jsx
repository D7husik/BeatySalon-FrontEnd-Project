...
import { generateTimeSlots, isSlotAvailable, validateBookingForm, isFormValid } from '../utils';
 ...
 * @param {Array} props.initialServices - Pre-selected services
 */
const BookingPage = ({ onNavigate, initialServices }) => {
    const {
        services,
        staff,
        appointments,
